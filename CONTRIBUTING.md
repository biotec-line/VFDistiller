...
Vielen Dank für Ihr Interesse, zu VFDistiller beizutragen.
...
### Code- und Datenrichtlinien

- Python: PEP 8 Stil
- Encoding: UTF-8 für alle Dateien
- Sprache: Code und Kommentare auf Deutsch oder Englisch
- Keine hardcoded Pfade oder API-Keys
- Keine Genomreferenzen, VCF-Dateien, SQLite-Datenbanken, Logs, lokalen Einstellungen oder Build-Artefakte committen
...
Thank you for your interest in contributing to VFDistiller.
...
- Do not commit genome references, VCF files, SQLite databases, logs, local settings, or build artifacts
